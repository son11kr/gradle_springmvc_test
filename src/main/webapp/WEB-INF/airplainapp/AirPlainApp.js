...
class AirPlainApp extends Component {
...
AirPlainApp.getStores = () => ([AirportStore]);
AirPlainApp.calculateState = (prevState) => ({
    airports: AirportStore.getState()
});

const AppContainer = Container.create(AirPlainApp);
